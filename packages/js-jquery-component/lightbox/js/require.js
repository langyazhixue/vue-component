...
;(function(ca) {
  ...
  function V(b, c, d, g) {
    c &&
      B(c, function(c, h) {
        if (d || !s(b, h)) {
          g && typeof c === 'object' && c && !H(c) && !G(c) && !(c instanceof RegExp)
            ? (b[h] || (b[h] = {}), V(b[h], c, d, g))
            : (b[h] = c)
        }
      })
  ...
  function ha(b) {
        ...
        if (e) {
          ...
          for (e = 0; e < d; e++) {
            if (((c = n[e]), c === '.')) n.splice(e, 1), (e -= 1)
              ...
              if (e === 1 && (n[2] === '..' || n[0] === '..')) break
              else e > 0 && (n.splice(e - 1, 2), (e -= 2))
            }
          }
          a = a.join('/')
    ...
    function g(a) {
      var e = j(l.paths, a)
      if (e && H(e) && e.length > 1) return e.shift(), i.require.undef(a), i.require([a]), !0
    }

    function u(a) {
      var e
      var b = a ? a.indexOf('!') : -1
      b > -1 && ((e = a.substring(0, b)), (a = a.substring(b + 1, a.length)))
      return [e, a]
    }
    ...
    function r(a, e, b) {
      var f = a.id
      var n = j(k, f)
      if (s(p, f) && (!n || n.defineEmitComplete)) e === 'defined' && b(p[f])
      else if (((n = q(a)), n.error && e === 'error')) b(n.error)
      else n.on(e, b)
    }
    ...
    function D() {
      var a
      var e
      var b = (a = 1e3 * l.waitSeconds) && i.startTime + a < new Date().getTime()
      var f = []
      var c = []
      var h = !1
      var k = !0
      ...
      callPlugin: function() {
        ...
        r(
          ...
          t(this, function(f) {
            ...
            var p = i.makeRequire(a.parentMap, {
              enableBuildCallback: !0
            })
              ...
              g
                ...
                : ((d = t(this, function(a) {
                  ...
                  (d.error = t(this, function(a) {
                    ...
                    a.requireModules = [b]
                    B(k, function(a) {
                      a.map.id.indexOf(b + '_unnormalized') === 0 && y(a.map.id)
                    })
                    w(a)
                  })),
    ...
    i = {
      ...
      onScriptLoad: function(a) {
        if (a.type === 'load' || ka.test((a.currentTarget || a.srcElement).readyState)) {
  ...
  var Q
  var la = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm
  var ma = /[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g
  var R = /\.js$/
  var ja = /^\.\//
  x = Object.prototype
  var M = x.toString
  var ga = x.hasOwnProperty
  var ia = Array.prototype.splice
  var z = !!(typeof window !== 'undefined' && typeof navigator !== 'undefined' && window.document)
  var fa = !z && typeof importScripts !== 'undefined'
  var ka = z && navigator.platform === 'PLAYSTATION 3' ? /^complete$/ : /^(complete|loaded)$/
  var Z = typeof opera !== 'undefined' && opera.toString() === '[object Opera]'
  var F = {}
  var r = {}
  var S = []
  var O = !1
  if (typeof define === 'undefined') {
    ...
    typeof require !== 'undefined' && !G(require) && ((r = require), (require = void 0))
    h = requirejs = function(b, c, d, g) {
      var u
      var m = '_'
      !H(b) && typeof b !== 'string' && ((u = b), H(c) ? ((b = c), (c = d), (d = g)) : (b = []))
    ...
    h.load = function(b, c, d) {
      ...
      if (z) {
        return (
          ...
          g.attachEvent &&
          !(g.attachEvent.toString && g.attachEvent.toString().indexOf('[native code') < 0) &&
          !Z
    ...
    define = function(b, c, d) {
      ...
      if (O) {
        if (!(g = L)) {
          ;(P && P.readyState === 'interactive') ||
            U(document.getElementsByTagName('script'), function(b) {
              if (b.readyState === 'interactive') return (P = b)
            }),
            (g = P)
        }
        g &&
